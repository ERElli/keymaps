 ...
 */
    [_MOUSE] = LAYOUT(
        ...
        KC_NO, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT,   KC_NO,                                     KC_BTN1, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,   KC_NO,
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_BTN2, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R,   KC_NO,
